    ...
    public class InstallTimerJobEventReceiver : SPFeatureReceiver
    {
        ...
        public void InstallFirstTimerJob(SPWeb web)
        {
            ...
            try
            {
                ...
                SampleTimerJob objFirstTimer = new SampleTimerJob("SampleProject.UI Sample Timer Job", web.Site.WebApplication);
        ...
        public void DeleteFirstTimerJob(SPWeb web)
        {
            try
            {
                SPJobDefinition objFirstTimerJob = web.Site.WebApplication.JobDefinitions["SampleProject.UI Sample Timer Job"];
